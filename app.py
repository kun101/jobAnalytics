...
pipe = pipeline("token-classification", model="GalalEwida/LLM-BERT-Model-Based-Skills-Extraction-from-jobdescription", token=st.secrets["ACCESS_TOKEN"] if os.environ['ACCESS_TOKEN'] is None else os.environ['ACCESS_TOKEN'])

# get uri from .env file
uri = st.secrets["MONGO_URL"] if os.environ['MONGO_URL'] is None else os.environ['MONGO_URL']
